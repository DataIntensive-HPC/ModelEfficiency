...
print("Calculating B1*(A1A2) contradiction")
TB1A1A2 = torch.einsum('kij,kabc -> ijabc' , [TB1, TA1A2])

print("Size of B1A1A2")
print(TB1A1A2.size())


print("Calculating (B1A1A2)*B2")
TB1A1A2B2 = torch.einsum('kijmn, ima -> kjna' , [TB1A1A2, TB2]) 

print("Size of B1A1A2B2")
